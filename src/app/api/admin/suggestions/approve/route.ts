  ...
  try {
    ...
    const { data: business, error: insertError } = await supabase
      ...
      .insert({
        ...
        has_whatsapp: suggestion.has_whatsapp || false,
        has_telegram: suggestion.has_telegram || false,
        has_signal: suggestion.has_signal || false,
        ...
        images: suggestion.pending_images, // pending_images become approved images
        is_active: true,
        is_verified: false,
        is_featured: false,
