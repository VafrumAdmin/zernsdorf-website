        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 sm:p-12">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-lg font-medium text-slate-800 mb-2">Haftung für Inhalte</h3>
              ...
              <h3 className="text-lg font-medium text-slate-800 mb-2">Haftung für Links</h3>
              <p className="text-slate-600 mb-4">
              ...
              <h3 className="text-lg font-medium text-slate-800 mb-2">Urheberrecht</h3>
              <p className="text-slate-600 mb-4">
